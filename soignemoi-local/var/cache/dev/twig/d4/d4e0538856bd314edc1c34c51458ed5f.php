...
class __TwigTemplate_b725a9f030870518a1c42d118afad9e9 extends Template
{
    ...
    <p><strong>Rôle(s):</strong> ";
        // line 10
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 10, $this->source); })()), "roles", [], "any", false, false, false, 10), ", "), "html", null, true);
        yield "</p>
...
";
    ...
    {
        return array (  111 => 5,  98 => 12,  93 => 10,  89 => 9,  84 => 6,  82 => 5,  77 => 4,  64 => 3,  41 => 1,);
    }
...
{% block content %}
    ...
    <p><strong>Rôle(s):</strong> {{ user.roles|join(', ') }}</p>

    <a href=\"{{ path('app_logout') }}\">Se déconnecter</a>
{% endblock %}
", "user/profile.html.twig", "/home/gerard/Bureau/soignemoi-symfony/soignemoi-local/templates/user/profile.html.twig");
    }
}
