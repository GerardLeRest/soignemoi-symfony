...
-- Insérer les utilisateurs (User)
INSERT INTO user (email, password, roles) VALUES
('alice.durand@example.com', '$2y$12$9iL2CE.1b2P3PK0r0Fb8MukCHVQx7MYl5TnoB2eqJOPw1/zFt7kaG', '["ROLE_USER"]'),
('ahmed.alfarsi@example.com', '$2y$12$KbROKz0vj3TV9/G.qF3Ic.QBp/zULFGY.UA6q2HBksUpdEv/ZFsX2', '["ROLE_USER"]'),
('kofi.adjoa@example.com', '$2y$12$UkPLcWV5u1EXV5rNtVapQ.Y0fqCcpv6vxv21Ju6XrTYkXKrl2z30q', '["ROLE_USER"]'),
('emilie.martin@example.com', '$2y$12$Fg.4bboJZkV8ts72cBFNY.z9lQCUa24Jx8rV/ZPQo8F56Fojl/uRy', '["ROLE_USER"]'),
('francois.girard@example.com', '$2y$12$ShBFHRPufyS45ymvDj5y6eyMcYGtl9zE1f0sI.GAKh41Ry7kUKi8m', '["ROLE_USER"]'),
('charlotte.martin@example.com', '$2y$12$6kUYdW.7LUed31Wtrt7TCOoOgHrz6K5mV8xXvOdF3I6xMIfWbjC82', '["ROLE_USER"]');

-- Insérer les patients (Patient) en les associant aux utilisateurs (User)
INSERT INTO patient (prenom, nom, adresse_postale, user_id) VALUES
('Alice', 'Durand', '10 Rue de Vitre, Chantepie', 1),
('Ahmed', 'Al-Farsi', '25 Avenue de Bretagne, Cesson-Sévigné', 2),
('Kofi', 'Adjoa', '8 Rue du Bocage, Vezin-le-Coquet', 3),
('Émilie', 'Martin', '32 Rue de Rennes, Saint-Grégoire', 4),
('François', 'Girard', '47 Rue de Lorient, Montgermont', 5),
('Charlotte', 'Martin', '15 Chemin des Ducs, Betton', 6);
